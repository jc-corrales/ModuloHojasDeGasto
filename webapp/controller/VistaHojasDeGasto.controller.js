sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.moduloDeHojasDeGasto.controller.VistaHojasDeGasto", {
		...
		createFiltersAndSorters: function () {
			...
			aPropertyFilters.push(new sap.ui.model.Filter("FechaProcedimiento", "EQ", "2020-10-11"));
			oBindingData.filters.push(new sap.ui.model.Filter(aPropertyFilters, true));

			oBindingData.sorters = [];

			oBindingData.sorters.push(new sap.ui.model.Sorter("Paciente", false, false));
			this.updateBindingOptions("sap_List_Page_0-content-sap_m_ObjectList-1602981970616", oBindingData);
			oBindingData = {};
			oBindingData.filters = [];
			aPropertyFilters = [];

			aPropertyFilters.push(new sap.ui.model.Filter("FechaProcedimiento", "EQ", "2020-10-12"));
			oBindingData.filters.push(new sap.ui.model.Filter(aPropertyFilters, true));

			this.updateBindingOptions("sap_List_Page_0-content-sap_m_ObjectList-1602981975060", oBindingData);
		...
		onInit: function () {
			...
			this.oRouter.getTarget("VistaHojasDeGasto").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
			this.mAggregationBindingOptions = {};
			this.createFiltersAndSorters();

			this.applyFiltersAndSorters("sap_List_Page_0-content-sap_m_ObjectList-1602981970616", "items");

			this.applyFiltersAndSorters("sap_List_Page_0-content-sap_m_ObjectList-1602981975060", "items");
		...
		onExit: function () {
			...
			var aControls = [{
				"controlId": "sap_List_Page_0-content-sap_m_ObjectList-1602981970616",
				"groups": ["items"]
			}, {
				"controlId": "sap_List_Page_0-content-sap_m_ObjectList-1602981975060",
				"groups": ["items"]
			}, {
